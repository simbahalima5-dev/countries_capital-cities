/**
 * Global Countries & Capital City History Database
 * Pure Vanilla JS Data Store
 */
...
const COUNTRIES_DATA = [
  {
    ...
    facts: {
      ...
      landArea: 377975, // sq km
      elevation: 44, // meters avg
  ...
  },
  {
    ...
    capital: {
      ...
      establishedYear: 1421, // As Imperial Capital under Ming
      type: "Historical Relocation",
  ...
  },
  {
    ...
    capital: {
      ...
      establishedYear: 508, // AD (Clovis I)
      type: "Ancient",
  ...
  },
  {
    ...
    facts: {
      ...
      landArea: 505990,
      elevation: 667, // One of Europe's highest capitals
  ...
  },
  {
    ...
    capital: {
      ...
      establishedYear: 1325, // Tenochtitlan
      type: "Ancient",
    ...
    facts: {
      ...
      landArea: 1964375,
      elevation: 2240, // High altitude valley
...
/**
 * Historical Capital Relocations Database for Timeline View
 */
const CAPITAL_TIMELINE_EVENTS = [
  {
    year: "753 BC",
